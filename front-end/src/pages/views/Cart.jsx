...
import { createOrder, deleteOrder, fetchMyOrders } from '../../redux/features/orderSlice.js';
                ...
                {cartItems.map((item) => (
                  ...
                  >
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='font-semibold'>Total: ${item.totalItemPrice}</p>
                    </div>
                    <motion.button
                      whileHover={{
                        scale: 1.05,
                ...
                <div key={order._id} className='border-4 border-black p-4'>
                  <div className='flex flex-col md:flex-row md:justify-between md:items-center gap-2'>
                    <div>
                      ...
                      <p className='font-semibold'>Delivered: {order.isDelivered ? 'Yes' : 'No'}</p>
                    </div>
                    <motion.button
                      whileHover={{
                        scale: 1.05,
                  ...
                  <div className='mt-3 grid grid-cols-1 md:grid-cols-2 gap-2'>
                    {order.items?.map((line) => (
                      <div key={line._id} className='border-2 border-black p-2'>
                        <p className='font-semibold'>{line.items?.brandName ?? line.items?.name ?? 'Item'}</p>
